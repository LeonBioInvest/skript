    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-16">
      ...
      <div className="fixed top-4 right-6 z-50">
        <button
          ...
          className="flex items-center gap-2 border border-border hover:border-accent/50 bg-surface hover:bg-surface2 text-text2 hover:text-text rounded-xl px-3 py-1.5 font-mono text-[11px] tracking-wider uppercase transition-all duration-150 shadow-sm"
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:border-accent/50 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(34,197,94,0.12)]',
